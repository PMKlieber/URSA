...
import com.example.ursa.ui.numimgs
import com.example.ursa.ui.theme.Purple700
import com.example.ursa.ui.theme.PurpleTint
import com.example.ursa.ui.theme.timerTextOk
import com.example.ursa.ui.theme.timerTextOver
import com.example.ursa.ui.theme.timerTextWarn
            ...
            if (buttons) {
                Button(
                    ...
                    onClick = {
                        ...
                        .padding(0.dp)
                        .height(28.dp)
                        .width(28.dp).align(Alignment.CenterStart)
                ) {
                    Image(
            ...
            if (adjButtons) {
                Button(
                    ...
                    onClick = {
                        ...
                        .padding(0.dp)
                        .height(28.dp)
                        .width(28.dp).align(Alignment.CenterEnd)
                ) {
                    Image(
...
fun FacilityIcon(
    ...
    Column(
        ...
        Box {
            ...
            Image(
                painter = painterResource(numimgs[num - 1]),
                contentDescription = null,
                modifier = Modifier.align(Alignment.Center)
            )
        }
        ...
        {
            Text(
                text = statusText, fontSize = 16.sp, textAlign = TextAlign.Center, fontWeight = FontWeight.Bold
            )
