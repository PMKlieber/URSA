...
import com.example.ursa.ui.testPatrons
...
class LaundryWasher (var num: Int, val status: MutableState<WasherStatus> = mutableStateOf(WasherStatus.OPEN) ){
    var occupant: LaundryPatron? by mutableStateOf( null)
}

class LaundryListViewModel( dataFilePath: String="test") {
