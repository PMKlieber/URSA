...
import org.lihi.ursa.LaundryPatron
            ...
            content = {
                when (status){
                    ...
                    WasherStatus.WASHING -> {
                        if (pat != null) {
                            TimeWidget(targetTime = pat.startTime+pat.washRunTime, adjButtons = true, onAdjButtonClick = {it -> laundryvm.adjWasherTime(num,it)}, getTimeUpdate = {pat.startTime+pat.washRunTime})
