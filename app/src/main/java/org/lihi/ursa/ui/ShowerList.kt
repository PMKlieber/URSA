...
import org.lihi.ursa.ui.theme.ListCompletedGray
import org.lihi.ursa.ui.theme.ListPatronCrossListCheckColor
        ...
        Row {
            LazyColumn {
                ...
                itemsIndexed(patrons) { positionIndex, pat ->
                    ...
                    val bgcolor= when{
                        pat.outTime>0 -> ListCompletedGray
                        pat.checkFromLaundryList -> ListPatronCrossListCheckColor
                        else -> Color.White
                    }
                            ...
                            Column(modifier = Modifier
                                ...
                                .clickable {
                                    ...
                                    selectedItemIndex.value =
                                        if (selectedItemIndex.value != positionIndex) positionIndex else -1
                                }) {
                                Row(verticalAlignment = Alignment.CenterVertically) {
                                    ...
                                    if (pat.checkFromLaundryList){
                                        Image(painterResource(R.drawable.washerrun),"From Laundry List",
                                            modifier = Modifier
                                                .size(32.dp)
                                                .padding(2.dp))
                                    }
                                    ...
                                    if (pat.checkFromLaundryList){
                                        Text("${-wait} minutes left in wash")
                                    }
                                    else if (pat.inTime == 0L) {
                                        Text(
                                                ...
                                                if (pat.inTime > 0) {
                                                    if (pat.outTime > 0) {
                                                        Row(horizontalArrangement=Arrangement.SpaceEvenly,
                                                            ...
                                                            Button(onClick = {showerlm.returnPatronToQueue(pat,pat.showerNum)}) { Text("Return to Queue") }
                                                        ...
                                                        Row(horizontalArrangement=Arrangement.SpaceEvenly,
                                                            ...
                                                            Button(onClick = {
                                                                showerlm.returnPatronToQueue(pat,pat.showerNum)
        ...
        Row(verticalAlignment = Alignment.Top, modifier = Modifier.weight(1f)) {
            rooms.forEachIndexed { roomid, room ->
                ...
                ShowerIcon(
                    roomid + 1,
                    room.status,
                    occupant = room.occupant?.name ?: "Err",
                    timein = room.occupant?.inTime ?: 0,
                    room = room,
