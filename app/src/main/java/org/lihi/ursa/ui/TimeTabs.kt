...
import org.lihi.ursa.laundryTime
import org.lihi.ursa.ui.theme.Purple200
...
@Composable
fun TimeTabs(selTime: MutableState<String>, washTimes: List<laundryTime>) {
...
fun SimpleComposablePreview() {
    ...
    TimeTabs(td, WEEKDAY_LAUNDRY_TIMES)
}